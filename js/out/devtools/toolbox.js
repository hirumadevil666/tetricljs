...
if(typeof devtools.toolbox.t_devtools$toolbox12099 !== 'undefined'){
} else {
...
*/
devtools.toolbox.t_devtools$toolbox12099 = (function (obj,header,style,tag,meta12100){
this.obj = obj;
this.header = header;
this.style = style;
this.tag = tag;
...
devtools.toolbox.t_devtools$toolbox12099.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_12101,meta12100__$1){
var self__ = this;
var _12101__$1 = this;
return (new devtools.toolbox.t_devtools$toolbox12099(self__.obj,self__.header,self__.style,self__.tag,meta12100__$1));
});

devtools.toolbox.t_devtools$toolbox12099.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_12101){
var self__ = this;
var _12101__$1 = this;
return self__.meta12100;
});

devtools.toolbox.t_devtools$toolbox12099.prototype.devtools$protocols$IFormat$ = cljs.core.PROTOCOL_SENTINEL;

devtools.toolbox.t_devtools$toolbox12099.prototype.devtools$protocols$IFormat$_header$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
devtools.toolbox.t_devtools$toolbox12099.prototype.devtools$protocols$IFormat$_has_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
return true;
});

devtools.toolbox.t_devtools$toolbox12099.prototype.devtools$protocols$IFormat$_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
devtools.toolbox.t_devtools$toolbox12099.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"obj","obj",-1672671807,null),new cljs.core.Symbol(null,"header","header",1759972661,null),new cljs.core.Symbol(null,"style","style",1143888791,null),new cljs.core.Symbol(null,"tag","tag",350170304,null),new cljs.core.Symbol(null,"meta12100","meta12100",1287286001,null)], null);
});

devtools.toolbox.t_devtools$toolbox12099.cljs$lang$type = true;

devtools.toolbox.t_devtools$toolbox12099.cljs$lang$ctorStr = "devtools.toolbox/t_devtools$toolbox12099";

devtools.toolbox.t_devtools$toolbox12099.cljs$lang$ctorPrWriter = (function (this__8293__auto__,writer__8294__auto__,opt__8295__auto__){
return cljs.core._write.call(null,writer__8294__auto__,"devtools.toolbox/t_devtools$toolbox12099");
});

devtools.toolbox.__GT_t_devtools$toolbox12099 = (function devtools$toolbox$__GT_t_devtools$toolbox12099(obj__$1,header__$1,style__$1,tag__$1,meta12100){
return (new devtools.toolbox.t_devtools$toolbox12099(obj__$1,header__$1,style__$1,tag__$1,meta12100));
});

}

return (new devtools.toolbox.t_devtools$toolbox12099(obj,header,style,tag,cljs.core.PersistentArrayMap.EMPTY));
});
