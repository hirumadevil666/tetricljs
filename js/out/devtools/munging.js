...
var o10259 = temp__4655__auto__;
var temp__4655__auto____$1 = (o10259["core"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o10260 = temp__4655__auto____$1;
return (o10260["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__9374__auto__ = f;
return (o__9374__auto__["toString"]).call(o__9374__auto__);
} else {
return "";
}
}catch (e10261){var _ = e10261;
return "";
}});
...
try{var o__9374__auto___10263 = t;
(o__9374__auto___10263["cljs$lang$ctorPrWriter"]).call(o__9374__auto___10263,t,writer);
}catch (e10262){var __10264 = e10262;
}
...
var char_code = (function (){var o__9374__auto__ = (new String(char$));
return (o__9374__auto__["charCodeAt"]).call(o__9374__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__9374__auto__ = String;
return (o__9374__auto__["fromCharCode"]).call(o__9374__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__10265 = num_code;
switch (G__10265) {
case (1):
return (185);
...
var o__9374__auto__ = String;
return (o__9374__auto__["fromCharCode"]).call(o__9374__auto__,superscript_code);
});
/**
...
}catch (e10267){var _e__9381__auto__ = e10267;
return false;
}})())){
...
var vec__10268 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__10268,(0),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var o10271 = temp__4655__auto__;
var temp__4655__auto____$1 = (o10271["dependencies_"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o10272 = temp__4655__auto____$1;
return (o10272["nameToPath"]);
} else {
return null;
}
} else {
...
var len__8839__auto___10279 = arguments.length;
var i__8840__auto___10280 = (0);
while(true){
if((i__8840__auto___10280 < len__8839__auto___10279)){
args__8846__auto__.push((arguments[i__8840__auto___10280]));

var G__10281 = (i__8840__auto___10280 + (1));
i__8840__auto___10280 = G__10281;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__10275){
var vec__10276 = p__10275;
var ns_detector = cljs.core.nth.call(null,vec__10276,(0),null);
...
var G__10282 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__10283 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__10282;
remaining_tokens = G__10283;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq10273){
var G__10274 = cljs.core.first.call(null,seq10273);
var seq10273__$1 = cljs.core.next.call(null,seq10273);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__10274,seq10273__$1);
});
...
var vec__10287 = cljs.core.split_with.call(null,(function (p1__10286_SHARP_){
return cljs.core.not_EQ_.call(null,p1__10286_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__10287,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__10287,(1),null);
...
var vec__10290 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__10290,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__10290,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__10293 = cljs.core.rest.call(null,remaining_tokens);
var G__10294 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__10293;
name_tokens = G__10294;
continue;
} else {
...
var vec__10297 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__10297,(0),null);
var arity = cljs.core.nth.call(null,vec__10297,(1),null);
var vec__10300 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__10300,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__10300,(1),null);
var vec__10303 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__10303,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__10303,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__10303,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__10303,(3),null);
...
var vec__10309 = result;
var munged_ns = cljs.core.nth.call(null,vec__10309,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__10309,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__10309,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__10309,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__10309,(4),null);
var arity = cljs.core.nth.call(null,vec__10309,(5),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var vec__10313 = temp__4655__auto__;
var munged_name = cljs.core.nth.call(null,vec__10313,(0),null);
var args = cljs.core.nth.call(null,vec__10313,(1),null);
var vec__10316 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__10316,(0),null);
var name = cljs.core.nth.call(null,vec__10316,(1),null);
...
var G__10319 = (arity + (1));
var G__10320 = (function (){var temp__4655__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__4655__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__10321){
var vec__10322 = p__10321;
var arity = cljs.core.nth.call(null,vec__10322,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__10322,(1),null);
...
return cljs.core.get.call(null,arities,p1__10325_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__10326_SHARP_);
...
var args__8846__auto__ = [];
var len__8839__auto___10333 = arguments.length;
var i__8840__auto___10334 = (0);
while(true){
if((i__8840__auto___10334 < len__8839__auto___10333)){
args__8846__auto__.push((arguments[i__8840__auto___10334]));

var G__10335 = (i__8840__auto___10334 + (1));
i__8840__auto___10334 = G__10335;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__10329){
var vec__10330 = p__10329;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__10330,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq10327){
var G__10328 = cljs.core.first.call(null,seq10327);
var seq10327__$1 = cljs.core.next.call(null,seq10327);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__10328,seq10327__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__10338__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__10338__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__10338__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__10338__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__10339 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__10339,(0),null);
var fn_name = cljs.core.nth.call(null,vec__10339,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__10339,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__10339,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__10339,(4),null);
var arity = cljs.core.nth.call(null,vec__10339,(5),null);
...
var o__9374__auto__ = f;
return (o__9374__auto__["getBasis"]).call(o__9374__auto__);
});
/**
...
}catch (e10343){var _e__9381__auto__ = e10343;
...
var G__10344 = (obj[cljs.core.first.call(null,path)]);
var G__10345 = cljs.core.rest.call(null,path);
obj = G__10344;
path = G__10345;
continue;
} else {
...
return (function (accum,p__10346){
var vec__10347 = p__10346;
var bit = cljs.core.nth.call(null,vec__10347,(0),null);
var protocol = cljs.core.nth.call(null,vec__10347,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__10350){
var vec__10351 = p__10350;
var ns = cljs.core.nth.call(null,vec__10351,(0),null);
var name = cljs.core.nth.call(null,vec__10351,(1),null);
var selector = cljs.core.nth.call(null,vec__10351,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__10356,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__10356,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__10356,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__10354_SHARP_){
return (obj[cljs.core.first.call(null,p1__10354_SHARP_)]);
});})(name,sorted_matches,vec__10356,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
