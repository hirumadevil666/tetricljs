...
var len__8839__auto___10390 = arguments.length;
var i__8840__auto___10391 = (0);
while(true){
if((i__8840__auto___10391 < len__8839__auto___10390)){
args__8846__auto__.push((arguments[i__8840__auto___10391]));

var G__10392 = (i__8840__auto___10391 + (1));
i__8840__auto___10391 = G__10392;
continue;
} else {
}
break;
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq10387){
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__10388,G__10389,seq10387__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__10393_SHARP_){
return !((cljs.core.meta.call(null,p1__10393_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__10394__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e10398){var _e__9381__auto__ = e10398;
return false;
}})();
if(cljs.core.truth_(or__7668__auto__)){
return or__7668__auto__;
...
}catch (e10400){var _e__9381__auto__ = e10400;
return false;
}}
})())){
...
var _STAR_current_state_STAR_10402 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__10403 = opts;
...
var markup_db = cljs.core.get.call(null,map__10403__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_10402;
}});
...
;
var temp__4655__auto___10407 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___10407)){
var managed_print_level_10408 = temp__4655__auto___10407;
var _STAR_print_level_STAR_10406_10409 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_10408;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_10406_10409,managed_print_level_10408,temp__4655__auto___10407,writer,opts,job_fn){
return (function (p1__10405_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__10405_SHARP_,null);
});})(_STAR_print_level_STAR_10406_10409,managed_print_level_10408,temp__4655__auto___10407,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_10406_10409;
}} else {
job_fn.call(null);
}
