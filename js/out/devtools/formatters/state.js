...
var len__8839__auto___10381 = arguments.length;
var i__8840__auto___10382 = (0);
while(true){
if((i__8840__auto___10382 < len__8839__auto___10381)){
args__8846__auto__.push((arguments[i__8840__auto___10382]));

var G__10383 = (i__8840__auto___10382 + (1));
i__8840__auto___10382 = G__10383;
continue;
} else {
}
break;
...
devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq10379){
var G__10380 = cljs.core.first.call(null,seq10379);
var seq10379__$1 = cljs.core.next.call(null,seq10379);
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__10380,seq10379__$1);
});
...
return (p1__10384_SHARP_ === object);
});})(history))
,history);
});
