...
var G__10361 = devtools.prefs.pref.call(null,v);
v = G__10361;
continue;
} else {
return v;
...
}catch (e10364){var _e__9381__auto__ = e10364;
return false;
}})();
...
}catch (e10368){var _e__9381__auto__ = e10368;
return false;
}})();
...
}catch (e10370){var _e__9381__auto__ = e10370;
return false;
}}
}
});
...
var vec__10372 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__10372,(0),null);
var name = cljs.core.nth.call(null,vec__10372,(1),null);
...
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__10375_SHARP_);
}),template);
});
