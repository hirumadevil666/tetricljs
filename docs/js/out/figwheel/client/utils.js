...
var or__44021__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj63565 = {"detail":data};
return obj63565;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__44009__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__44009__auto__)){
var and__44009__auto____$1 = goog.object.get(window,"CustomEvent");
...
var f = (function (){var pred__63572 = cljs.core._EQ_;
var expr__63573 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__63572.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__63573))){
return ((function (pred__63572,expr__63573){
return (function (p1__63566_SHARP_){
return console.warn(p1__63566_SHARP_);
});
;})(pred__63572,expr__63573))
} else {
if(cljs.core.truth_(pred__63572.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__63573))){
return ((function (pred__63572,expr__63573){
return (function (p1__63567_SHARP_){
return console.debug(p1__63567_SHARP_);
});
;})(pred__63572,expr__63573))
} else {
if(cljs.core.truth_(pred__63572.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__63573))){
return ((function (pred__63572,expr__63573){
return (function (p1__63568_SHARP_){
return console.error(p1__63568_SHARP_);
});
;})(pred__63572,expr__63573))
} else {
return ((function (pred__63572,expr__63573){
return (function (p1__63569_SHARP_){
return console.log(p1__63569_SHARP_);
});
;})(pred__63572,expr__63573))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__63576){
var map__63577 = p__63576;
var map__63577__$1 = ((((!((map__63577 == null)))?((((map__63577.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__63577.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__63577):map__63577);
var opts = map__63577__$1;
var eval_fn = cljs.core.get.call(null,map__63577__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return (function (p1__63579_SHARP_){
return new_def.callback(p1__63579_SHARP_);
});})(new_def))
);
...
return (function (p__63580){
var vec__63581 = p__63580;
var ky = cljs.core.nth.call(null,vec__63581,(0),null);
var v = cljs.core.nth.call(null,vec__63581,(1),null);
...
if(cljs.core.truth_((function (){var and__44009__auto__ = typeof localStorage !== 'undefined';
...
}catch (e63586){if((e63586 instanceof Error)){
var e = e63586;
return not_found;
} else {
throw e63586;
...
//# sourceMappingURL=utils.js.map?rel=1510936794499
