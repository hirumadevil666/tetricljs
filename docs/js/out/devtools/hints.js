...
var reader = (function (){var or__44021__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"file-reader","file-reader",-450847664));
...
var min_length = (function (){var or__44021__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"sanity-hint-min-length","sanity-hint-min-length",104958154));
if(cljs.core.truth_(or__44021__auto__)){
return or__44021__auto__;
} else {
return (128);
...
var map__61133 = top_item;
var map__61133__$1 = ((((!((map__61133 == null)))?((((map__61133.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__61133.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__61133):map__61133);
var file = cljs.core.get.call(null,map__61133__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__61133__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__61133__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e61132){var _e = e61132;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__4655__auto___61135 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__4655__auto___61135)){
var seen_errors_61136 = temp__4655__auto___61135;
if(cljs.core.truth_(seen_errors_61136.has(self))){
} else {
seen_errors_61136.add(self);

var temp__4657__auto___61137 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__4657__auto___61137)){
var sense_61138 = temp__4657__auto___61137;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_61138)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1510936791172
