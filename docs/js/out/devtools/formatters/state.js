...
var len__45192__auto___59493 = arguments.length;
var i__45193__auto___59494 = (0);
while(true){
if((i__45193__auto___59494 < len__45192__auto___59493)){
args__45199__auto__.push((arguments[i__45193__auto___59494]));

var G__59495 = (i__45193__auto___59494 + (1));
i__45193__auto___59494 = G__59495;
continue;
} else {
}
break;
...
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__45200__auto__);
});
...
devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq59491){
var G__59492 = cljs.core.first.call(null,seq59491);
var seq59491__$1 = cljs.core.next.call(null,seq59491);
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__59492,seq59491__$1);
});
...
return (p1__59496_SHARP_ === object);
});})(history))
,history);
});
...
//# sourceMappingURL=state.js.map?rel=1510936788004
