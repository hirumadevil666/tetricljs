...
var len__45192__auto___59502 = arguments.length;
var i__45193__auto___59503 = (0);
while(true){
if((i__45193__auto___59503 < len__45192__auto___59502)){
args__45199__auto__.push((arguments[i__45193__auto___59503]));

var G__59504 = (i__45193__auto___59503 + (1));
i__45193__auto___59503 = G__59504;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__45200__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq59499){
var G__59500 = cljs.core.first.call(null,seq59499);
var seq59499__$1 = cljs.core.next.call(null,seq59499);
var G__59501 = cljs.core.first.call(null,seq59499__$1);
var seq59499__$2 = cljs.core.next.call(null,seq59499__$1);
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__59500,G__59501,seq59499__$2);
});
...
if(cljs.core.truth_((function (){var or__44021__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__44646__auto__,writer__44647__auto__,opt__44648__auto__){
return cljs.core._write.call(null,writer__44647__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__44009__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__44009__auto__){
var or__44021__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__44021__auto__)){
return or__44021__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__59505_SHARP_){
return !((cljs.core.meta.call(null,p1__59505_SHARP_) == null));
})))){
...
var map__59506 = opts;
var map__59506__$1 = ((((!((map__59506 == null)))?((((map__59506.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__59506.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__59506):map__59506);
var markup_db = cljs.core.get.call(null,map__59506__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__44021__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e59510){var _e__46290__auto__ = e59510;
return false;
}})();
if(cljs.core.truth_(or__44021__auto__)){
return or__44021__auto__;
...
}catch (e59512){var _e__46290__auto__ = e59512;
return false;
}}
})())){
...
var _STAR_current_state_STAR_59514 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__59515 = opts;
var map__59515__$1 = ((((!((map__59515 == null)))?((((map__59515.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__59515.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__59515):map__59515);
var markup_db = cljs.core.get.call(null,map__59515__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_59514;
}});
...
;
var temp__4655__auto___59519 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___59519)){
var managed_print_level_59520 = temp__4655__auto___59519;
var _STAR_print_level_STAR_59518_59521 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_59520;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_59518_59521,managed_print_level_59520,temp__4655__auto___59519,writer,opts,job_fn){
return (function (p1__59517_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__59517_SHARP_,null);
});})(_STAR_print_level_STAR_59518_59521,managed_print_level_59520,temp__4655__auto___59519,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_59518_59521;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1510936788100
