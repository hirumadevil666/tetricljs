...
var G__59473 = devtools.prefs.pref.call(null,v);
v = G__59473;
continue;
} else {
return v;
...
var and__44009__auto__ = cljs.core.not.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"disable-cljs-fn-formatting","disable-cljs-fn-formatting",1903786837)));
if(and__44009__auto__){
var and__44009__auto____$1 = !(cljs.core.var_QMARK_.call(null,value));
...
var or__44021__auto__ = (function (){try{if(!((value == null))){
...
}catch (e59476){var _e__46290__auto__ = e59476;
return false;
}})();
if(cljs.core.truth_(or__44021__auto__)){
return or__44021__auto__;
} else {
var or__44021__auto____$1 = (function (){try{if(!((value == null))){
...
}catch (e59480){var _e__46290__auto__ = e59480;
return false;
}})();
...
}catch (e59482){var _e__46290__auto__ = e59482;
return false;
}}
}
});
devtools.formatters.helpers.cljs_type_QMARK_ = (function devtools$formatters$helpers$cljs_type_QMARK_(f){
var and__44009__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__44009__auto__)){
var and__44009__auto____$1 = cljs.core.not.call(null,devtools.formatters.helpers.is_prototype_QMARK_.call(null,f));
if(and__44009__auto____$1){
...
var and__44009__auto__ = goog.isObject(value);
if(cljs.core.truth_(and__44009__auto__)){
...
var or__44021__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(or__44021__auto__)){
return or__44021__auto__;
} else {
...
var and__44009__auto__ = (function (){var or__44021__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_.call(null,value);
if(cljs.core.truth_(or__44021__auto__)){
return or__44021__auto__;
} else {
...
var vec__59484 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__59484,(0),null);
var name = cljs.core.nth.call(null,vec__59484,(1),null);
...
var and__44009__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(and__44009__auto__)){
...
var or__44021__auto__ = typeof value === 'string';
if(or__44021__auto__){
return or__44021__auto__;
} else {
var or__44021__auto____$1 = typeof value === 'number';
...
return cljs.core.some.call(null,(function (p1__59487_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__59487_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1510936787967
