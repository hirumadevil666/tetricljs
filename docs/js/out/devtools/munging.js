...
var o59371 = temp__4655__auto__;
var temp__4655__auto____$1 = (o59371["core"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o59372 = temp__4655__auto____$1;
return (o59372["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__46283__auto__ = f;
return (o__46283__auto__["toString"]).call(o__46283__auto__);
} else {
return "";
}
}catch (e59373){var _ = e59373;
return "";
}});
...
try{var o__46283__auto___59375 = t;
(o__46283__auto___59375["cljs$lang$ctorPrWriter"]).call(o__46283__auto___59375,t,writer);
}catch (e59374){var __59376 = e59374;
}
...
var char_code = (function (){var o__46283__auto__ = (new String(char$));
return (o__46283__auto__["charCodeAt"]).call(o__46283__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__46283__auto__ = String;
return (o__46283__auto__["fromCharCode"]).call(o__46283__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__59377 = num_code;
switch (G__59377) {
case (1):
return (185);
...
var o__46283__auto__ = String;
return (o__46283__auto__["fromCharCode"]).call(o__46283__auto__,superscript_code);
});
/**
...
}catch (e59379){var _e__46290__auto__ = e59379;
return false;
}})())){
...
var vec__59380 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__59380,(0),null);
...
var or__44021__auto__ = (function (){var temp__4655__auto__ = cljs.core.re_matches.call(null,/(.*)\$/,s);
if(cljs.core.truth_(temp__4655__auto__)){
...
if(cljs.core.truth_(temp__4655__auto__)){
var o59383 = temp__4655__auto__;
var temp__4655__auto____$1 = (o59383["dependencies_"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o59384 = temp__4655__auto____$1;
return (o59384["nameToPath"]);
} else {
return null;
}
} else {
...
var len__45192__auto___59391 = arguments.length;
var i__45193__auto___59392 = (0);
while(true){
if((i__45193__auto___59392 < len__45192__auto___59391)){
args__45199__auto__.push((arguments[i__45193__auto___59392]));

var G__59393 = (i__45193__auto___59392 + (1));
i__45193__auto___59392 = G__59393;
continue;
} else {
}
break;
...
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__45200__auto__);
});

devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__59387){
var vec__59388 = p__59387;
var ns_detector = cljs.core.nth.call(null,vec__59388,(0),null);
var effective_detector = (function (){var or__44021__auto__ = ns_detector;
if(cljs.core.truth_(or__44021__auto__)){
return or__44021__auto__;
} else {
...
var G__59394 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__59395 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__59394;
remaining_tokens = G__59395;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq59385){
var G__59386 = cljs.core.first.call(null,seq59385);
var seq59385__$1 = cljs.core.next.call(null,seq59385);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__59386,seq59385__$1);
});
...
var vec__59399 = cljs.core.split_with.call(null,(function (p1__59398_SHARP_){
return cljs.core.not_EQ_.call(null,p1__59398_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__59399,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__59399,(1),null);
...
var vec__59402 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__59402,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__59402,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__59405 = cljs.core.rest.call(null,remaining_tokens);
var G__59406 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__59405;
name_tokens = G__59406;
continue;
} else {
...
var vec__59409 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__59409,(0),null);
var arity = cljs.core.nth.call(null,vec__59409,(1),null);
var vec__59412 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__59412,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__59412,(1),null);
var vec__59415 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__59415,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__59415,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__59415,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__59415,(3),null);
...
var vec__59421 = result;
var munged_ns = cljs.core.nth.call(null,vec__59421,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__59421,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__59421,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__59421,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__59421,(4),null);
var arity = cljs.core.nth.call(null,vec__59421,(5),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var vec__59425 = temp__4655__auto__;
var munged_name = cljs.core.nth.call(null,vec__59425,(0),null);
var args = cljs.core.nth.call(null,vec__59425,(1),null);
var vec__59428 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__59428,(0),null);
var name = cljs.core.nth.call(null,vec__59428,(1),null);
...
var G__59431 = (arity + (1));
var G__59432 = (function (){var temp__4655__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__4655__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__59433){
var vec__59434 = p__59433;
var arity = cljs.core.nth.call(null,vec__59434,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__59434,(1),null);
...
var fixed_arities = devtools.munging.collect_fn_fixed_arities.call(null,f,(function (){var or__44021__auto__ = max_fixed_arity;
if(cljs.core.truth_(or__44021__auto__)){
return or__44021__auto__;
} else {
...
return cljs.core.get.call(null,arities,p1__59437_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return (function (p1__59438_SHARP_){
return cljs.core.drop.call(null,(2),p1__59438_SHARP_);
...
var args__45199__auto__ = [];
var len__45192__auto___59445 = arguments.length;
var i__45193__auto___59446 = (0);
while(true){
if((i__45193__auto___59446 < len__45192__auto___59445)){
args__45199__auto__.push((arguments[i__45193__auto___59446]));

var G__59447 = (i__45193__auto___59446 + (1));
i__45193__auto___59446 = G__59447;
continue;
} else {
}
break;
...
var argseq__45200__auto__ = ((((1) < args__45199__auto__.length))?(new cljs.core.IndexedSeq(args__45199__auto__.slice((1)),(0),null)):null);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__45200__auto__);
});

devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__59441){
var vec__59442 = p__59441;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__59442,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq59439){
var G__59440 = cljs.core.first.call(null,seq59439);
var seq59439__$1 = cljs.core.next.call(null,seq59439);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__59440,seq59439__$1);
});
...
return devtools.munging.args_lists_to_strings.call(null,devtools.munging.arities_to_args_lists.call(null,(function (){var or__44021__auto__ = devtools.munging.collect_fn_arities.call(null,f);
if(cljs.core.truth_(or__44021__auto__)){
return or__44021__auto__;
} else {
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var and__44009__auto__ = include_ns_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?protocol_ns:null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_name)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?".":null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(protocol_name)].join(''):null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_method)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var or__44021__auto__ = include_protocol_ns_QMARK_;
if(cljs.core.truth_(or__44021__auto__)){
return or__44021__auto__;
} else {
...
var map__59450 = options;
var map__59450__$1 = ((((!((map__59450 == null)))?((((map__59450.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__59450.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__59450):map__59450);
var include_ns_QMARK_ = cljs.core.get.call(null,map__59450__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__59450__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__59450__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__59450__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__59451 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__59451,(0),null);
var fn_name = cljs.core.nth.call(null,vec__59451,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__59451,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__59451,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__59451,(4),null);
var arity = cljs.core.nth.call(null,vec__59451,(5),null);
...
var protocol_part = (cljs.core.truth_((function (){var and__44009__auto__ = protocol_ns;
if(cljs.core.truth_(and__44009__auto__)){
return cljs.core.not.call(null,(function (){var and__44009__auto____$1 = silence_common_protocols_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var or__44021__auto__ = protocol_part;
if(cljs.core.truth_(or__44021__auto__)){
return or__44021__auto__;
} else {
return fn_part;
...
var o__46283__auto__ = f;
return (o__46283__auto__["getBasis"]).call(o__46283__auto__);
});
/**
...
if(cljs.core.truth_((function (){var and__44009__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__44009__auto__)){
...
}catch (e59455){var _e__46290__auto__ = e59455;
...
var G__59456 = (obj[cljs.core.first.call(null,path)]);
var G__59457 = cljs.core.rest.call(null,path);
obj = G__59456;
path = G__59457;
continue;
} else {
...
var partition_bits = (function (){var or__44021__auto__ = (obj[partition_key]);
if(cljs.core.truth_(or__44021__auto__)){
return or__44021__auto__;
} else {
return (0);
...
return (function (accum,p__59458){
var vec__59459 = p__59458;
var bit = cljs.core.nth.call(null,vec__59459,(0),null);
var protocol = cljs.core.nth.call(null,vec__59459,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__59462){
var vec__59463 = p__59462;
var ns = cljs.core.nth.call(null,vec__59463,(0),null);
var name = cljs.core.nth.call(null,vec__59463,(1),null);
var selector = cljs.core.nth.call(null,vec__59463,(2),null);
...
return (function (p__59467){
var vec__59468 = p__59467;
var munged_name = cljs.core.nth.call(null,vec__59468,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__59468,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__59468,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__59466_SHARP_){
return (obj[cljs.core.first.call(null,p1__59466_SHARP_)]);
});})(name,sorted_matches,vec__59468,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1510936787872
