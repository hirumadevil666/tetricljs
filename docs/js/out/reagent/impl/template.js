...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__44646__auto__,writer__44647__auto__,opt__44648__auto__){
return cljs.core._write.call(null,writer__44647__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__58829 = o;
(G__58829[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__58830__delegate = function (args){
...
while (G__58831__i < G__58831__a.length) {G__58831__a[G__58831__i] = arguments[G__58831__i + 0]; ++G__58831__i;}
  args = new cljs.core.IndexedSeq(G__58831__a,0,null);
} 
return G__58830__delegate.call(this,args);};
G__58830.cljs$lang$maxFixedArity = 0;
G__58830.cljs$lang$applyTo = (function (arglist__58832){
var args = cljs.core.seq(arglist__58832);
return G__58830__delegate(args);
});
...
if(cljs.core.truth_((function (){var and__44009__auto__ = !((jsprops == null));
if(and__44009__auto__){
var and__44009__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__58835 = jsprops;
(G__58835["defaultValue"] = value);

(G__58835["onChange"] = ((function (G__58835,v,value,on_change){
return (function (p1__58834_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__58834_SHARP_);
});})(G__58835,v,value,on_change))
);
...
var vec__58838 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__58838,(0),null);
var id = cljs.core.nth.call(null,vec__58838,(1),null);
var class$ = cljs.core.nth.call(null,vec__58838,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___58842 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___58842 == null)){
} else {
var key_58843 = temp__4661__auto___58842;
(jsprops["key"] = key_58843);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__58844 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__58844["name"] = c);
...
var len__45192__auto___58849 = arguments.length;
var i__45193__auto___58850 = (0);
while(true){
if((i__45193__auto___58850 < len__45192__auto___58849)){
args__45199__auto__.push((arguments[i__45193__auto___58850]));

var G__58851 = (i__45193__auto___58850 + (1));
i__45193__auto___58850 = G__58851;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__45200__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq58847){
var G__58848 = cljs.core.first.call(null,seq58847);
var seq58847__$1 = cljs.core.next.call(null,seq58847);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__58848,seq58847__$1);
});
...
break;
default:
var G__58854 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__58854;
continue;
...
var n__44968__auto___58856 = a.length;
var i_58857 = (0);
while(true){
if((i_58857 < n__44968__auto___58856)){
(a[i_58857] = reagent.impl.template.as_element.call(null,(a[i_58857])));

var G__58858 = (i_58857 + (1));
i_58857 = G__58858;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__44968__auto___58859 = a.length;
var i_58860 = (0);
while(true){
if((i_58860 < n__44968__auto___58859)){
var val_58861 = (a[i_58860]);
if((cljs.core.vector_QMARK_.call(null,val_58861)) && ((reagent.impl.template.key_from_vec.call(null,val_58861) == null))){
(o["no-key"] = true);
} else {
}

(a[i_58860] = reagent.impl.template.as_element.call(null,val_58861));

var G__58862 = (i_58860 + (1));
i_58860 = G__58862;
continue;
} else {
}
...
var ctx = ({});
var vec__58863 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__58863,(0),null);
var derefed = cljs.core.nth.call(null,vec__58863,(1),null);
...
var G__58866 = (cljs.core.count.call(null,argv) - first_child);
switch (G__58866) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__58866){
...
//# sourceMappingURL=template.js.map?rel=1510936786783
